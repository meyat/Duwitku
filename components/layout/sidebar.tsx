  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 shrink-0 h-screen sticky top-0 border-r border-border p-6">
      <div className="flex items-center gap-2 mb-10">
        <Image src="/logo-mark-64.png" alt="Duwitku" width={32} height={32} className="shrink-0" />
        <span className="font-bold text-xl tracking-tight text-foreground">Duwitku</span>
      </div>
