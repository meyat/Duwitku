...
import { formatDate, safePercentage, daysUntil } from "@/lib/utils";
...
export default function DebtDetailPage() {
  ...
  async function handleDelete() {
    const ok = await confirmDialog({
      title: "Hapus data utang/piutang ini?",
      description: "Seluruh riwayat cicilan dan pembayaran juga akan terhapus. Aksi ini tidak bisa dibatalkan.",
      danger: true,
      confirmLabel: "Hapus",
    });
    if (!ok) return;
